package org.flixel
{
	...
	public class FlxU
	{
		 ...
		 */
		static public function computeVelocity(Velocity:Number, Acceleration:Number=0, Drag:Number=0, Max:Number=int.MAX_VALUE):Number
		{
			if(Acceleration != 0)
			...
			if((Velocity != 0) && (Max != int.MAX_VALUE))
			{
				if(Velocity > Max)
					Velocity = Max;
