package org.flixel.data
{
	...
	public class FlxMouse
	{
		...
		/**
		 * Helper for tracking the scrollwheel.
		 */
		protected var _scroll:int;
		/**
		 * Likewise.
		 */
		protected var _scrollast:int;
		 ...
		 * 
		 * @return	Whether the mousewheel is scrolling up.
		 */
		public function scrollingUp():Boolean { return _scrollast > 0; }
		
		/**
		 * Check if the mousewheel is scrolling down.
		 * 
		 * @return	Whether the mousewheel is scrolling down.
		 */
		public function scrollingDown():Boolean { return _scrollast < 0; }
		...
		/**
		 * Event handler so FlxGame can track the scrollwheel.
		 * 
		 * @param	event	A <code>MouseEvent</code> object.
		 */
		public function handleMouseScroll(event:MouseEvent):void
		{
			_scroll = event.delta;
		}
