package org.flixel.data
{
	...
	public class FlxPanel extends FlxObject
	{
		...
		override public function update():void
		{
			...
			_topBar.reset(_topBar.x, y);
			_mainBar.reset(_mainBar.x, y+1);
			_bottomBar.reset(_bottomBar.x, y+20);
		...
		{
			FlxU.openURL("https://www.paypal.com/cgi-bin/webscr?cmd=_xclick&business="+encodeURIComponent(_payPalID)+"&item_name="+encodeURIComponent(_gameTitle+" Contribution ("+_gameURL)+")&currency_code=USD");
		}
