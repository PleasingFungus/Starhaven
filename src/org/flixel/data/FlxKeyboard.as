package org.flixel.data
{
	...
	public class FlxKeyboard
	{
		...
		public var NUM1:Boolean;
		public var NUM2:Boolean;
		public var NUM3:Boolean;
		public var NUM4:Boolean;
		public var NUM5:Boolean;
		public var NUM6:Boolean;
		public var NUM7:Boolean;
		public var NUM8:Boolean;
		public var NUM9:Boolean;
		public var NUM0:Boolean;
		...
		/**
		 * Check to see if any key was just pressed.
		 *
		 * @return Whether any key was just pressed.
		 */
		public function anyKey():Boolean {
			var pressed:Boolean = false;
			for (var i:int = 0; !pressed && i < _t; i++) pressed = _map[i] && _map[i].current == 2;
			return pressed;
		}
		
		/**
		 * Find the Flixel name associated with a Flash keycode, if any.
		 *
		 * @param	KeyCode	The Flash keycode you want to find the name of.
		 * @return The Flixel name of the provided keycode.
		 */
		public function keycodeToName(KeyCode:int):String {
			return _map[KeyCode].name;
		}
		
		/**
		 * Find the Flash keycode associated with a Flixel keyname.
		 *
		 * @param	KeyName	The Flixel keyname you want to find the keycode for.
		 * @return The Flash keycode for the provided keyname.
		 */
		public function nameToKeycode(KeyName:String):int {
