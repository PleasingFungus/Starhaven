	...
	*/
	public class FlxSprite extends FlxObject
	{
		...
		*/
		 ...
		 * @private
		 */
		public function set facing(Direction:int):void
		{
		...
		override public function overlapsPoint(X:Number,Y:Number,PerPixel:Boolean = false):Boolean
		{
			...
			else if((X <= _point.x) || (X >= _point.x+width) || (Y <= _point.y) || (Y >= _point.y+height))
				return false;
			return true;
		}
		...
		public function getRaw():BitmapData {
			return _framePixels;
		}
	}
}