package org.flixel
{
	...
	public class FlxText extends FlxSprite
	{
		...
		/*
		 * The actual width of the internal text-format object.
		 */
		public function get textWidth():Number {
			return _tf.textWidth;
		}
		
		public function get endWidth():Number {
			if (_tf.numLines <= 1)
				return _tf.textWidth;
			for (var w:int = FlxG.width; _tf.getCharIndexAtPoint(w, height - 5) == -1; w--)
				w;
			return w;
		}
		...
		/**
		 * A helper function for rendering shadow.
		 */
		protected function renderShadow(tfa:TextFormat):void {
